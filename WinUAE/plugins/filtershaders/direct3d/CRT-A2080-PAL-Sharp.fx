...
// calculating scanlines
	...
	ref1 = pow(ref1, lerp(float3(1.15,1.15,1.15), float3(0.65,0.65,0.65), ref1));
	ref2 = pow(ref2, lerp(float3(1.15,1.15,1.15), float3(0.65,0.65,0.65), ref2));
